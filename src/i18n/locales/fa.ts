...
export const STRINGS_FA = {
    ...
    modals: {
        ...
        welcome: {
            ...
            introText:
                'سلام! ویدیوی زیر یک دوره کامل یک‌ساعته در ۱۴ فصل است. قبل از شروع، اکیداً توصیه می‌کنم سه فصل اول را تماشا کنید تا مدل پنل‌ها را درک کنید — ایده‌ای که کل افزونه بر پایه آن ساخته شده است.',
            continueText:
                'اگر ده دقیقه دیگر وقت دارید، با فصل‌های راه‌اندازی اولیه و روال روزانه ادامه دهید تا تنظیمات پیشنهادی و دو کلید میانبر مهم را تنظیم کنید.',
