...
export const STRINGS_TH = {
    ...
    modals: {
        ...
        welcome: {
            ...
            introText:
                'สวัสดี! วิดีโอด้านล่างเป็นคอร์สฉบับสมบูรณ์ความยาวหนึ่งชั่วโมง แบ่งเป็น 14 บท ก่อนเริ่มต้น ขอแนะนำอย่างยิ่งให้ดูสามบทแรกเพื่อทำความเข้าใจโมเดลแผงควบคุม ซึ่งเป็นแนวคิดหลักที่ปลั๊กอินทั้งหมดสร้างขึ้นมา',
            continueText:
                'หากคุณมีเวลาอีกสิบนาที ให้ดูบทเรื่องการตั้งค่าเริ่มแรกและการใช้งานประจำวันต่อ เพื่อตั้งค่าที่แนะนำและปุ่มลัดสำคัญที่สุดสองปุ่ม',
