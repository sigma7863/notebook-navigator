...
export const STRINGS_AR = {
    ...
    modals: {
        ...
        welcome: {
            ...
            introText:
                'مرحباً! الفيديو أدناه دورة كاملة مدتها ساعة واحدة في 14 فصلاً. قبل البدء، أوصي بشدة بمشاهدة الفصول الثلاثة الأولى لفهم نموذج اللوحات — الفكرة التي يقوم عليها المكوّن الإضافي بأكمله.',
            continueText:
                'إذا كان لديك عشر دقائق إضافية، تابع مع فصلي الإعداد الأولي وسير العمل اليومي لضبط الإعدادات الموصى بها وأهم مفتاحي اختصار.',
