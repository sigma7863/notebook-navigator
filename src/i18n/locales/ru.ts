...
export const STRINGS_RU = {
    ...
    modals: {
        ...
        welcome: {
            ...
            introText:
                'Привет! Видео ниже — это полный часовой курс из 14 глав. Перед началом работы настоятельно рекомендую посмотреть первые три главы, чтобы понять модель панелей — идею, на которой построен весь плагин.',
            continueText:
                'Если у вас есть ещё десять минут, продолжите с главами о первоначальной настройке и повседневной работе, чтобы задать рекомендуемые настройки и две самые важные горячие клавиши.',
