...
export const STRINGS_UK = {
    ...
    modals: {
        ...
        welcome: {
            ...
            introText:
                'Привіт! Відео нижче — це повний годинний курс із 14 розділів. Перш ніж почати, наполегливо рекомендую переглянути перші три розділи, щоб зрозуміти модель панелей — ідею, на якій побудовано весь плагін.',
            continueText:
                'Якщо у вас є ще десять хвилин, продовжте з розділами про початкове налаштування та щоденну роботу, щоб налаштувати рекомендовані параметри та дві найважливіші гарячі клавіші.',
